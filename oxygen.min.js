...
return"', "+n+", '"},c=function(t,r){return null===t||void 0===t||t===!1?r:t}
...
e.push(i)}return e},capitalize:function(t){t=c(t,"")
var r=t.toLowerCase()
return o(t,r.charAt(0).toUpperCase()+r.slice(1))},center:function(t,r){if(t=c(t,""),r=r||80,t.length>=r)return t
...
return r||(a.isString(e)&&(e=e.toUpperCase()),a.isString(i)&&(i=i.toUpperCase())),e>i?1:e===i?0:-1}),e},dump:function(t){return JSON.stringify(t)},escape:function(t){return"string"==typeof t||t instanceof i?a.escape(t):t},safe:function(t){return new i(t)},first:function(t){return t[0]},groupby:function(t,r){for(var n={},e=a.isFunction(r)?r:function(t){return t[r]},i=0;i<t.length;i++){var o=t[i],u=e(o,i);(n[u]||(n[u]=[])).push(o)}return n},indent:function(t,r,n){if(t=c(t,""),""===t)return""
r=r||4
for(var e="",i=t.split("\n"),u=a.repeat(" ",r),f=0;f<i.length;f++)e+=0!==f||n?u+i[f]+"\n":i[f]+"\n"
return o(t,e)},join:function(t,r,n){return r=r||"",n&&(t=a.map(t,function(t){return t[n]})),t.join(r)},last:function(t){return t[t.length-1]},length:function(t){var r=c(val,"")
...
throw new"list filter: type not iterable"},lower:function(t){return t=c(t,""),t.toLowerCase()},random:function(t){return t[Math.floor(Math.random()*t.length)]},rejectattr:function(t,r){return t.filter(function(t){return!t[r]})},selectattr:function(t,r){return t.filter(function(t){return!!t[r]})},replace:function(t,r,n,e){var u="",a=t
...
var f=t.indexOf(r)
if(0===e||-1===f)return t
for(var c=0,s=0;f>-1&&(-1===e||e>s);)u+=t.substring(c,f)+n,c=f+r.length,s++,f=t.indexOf(r,c)
return c<t.length&&(u+=t.substring(c)),o(a,u)},reverse:function(t){var r=a.map(t,function(t){return t})
return r.reverse(),r},round:function(t,r,n){r=r||0
var e,i=Math.pow(10,r)
return e="ceil"==n?Math.ceil:"floor"==n?Math.floor:Math.round,e(t*i)/i},slice:function(t,r,n){for(var e=Math.floor(t.length/r),i=t.length%r,o=0,u=[],a=0;r>a;a++){var f=o+a*e
i>a&&o++
var c=o+(a+1)*e,s=t.slice(f,c)
n&&a>=i&&s.push(n),u.push(s)}return u},sort:function(t,r,n,e){return t=a.map(t,function(t){return t}),t.sort(function(t,i){var o,u
return e?(o=t[e],u=i[e]):(o=t,u=i),!n&&a.isString(o)&&a.isString(u)&&(o=o.toLowerCase(),u=u.toLowerCase()),u>o?r?1:-1:o>u?r?-1:1:0}),t},string:function(t){return o(t,t)},striptags:function(t,r){t=c(t,""),r=r||!1
var n=/<\/?([a-z][a-z0-9]*)\b[^>]*>|<!--[\s\S]*?-->/gi,e=filters.trim(t.replace(n,"")),i=""
return i=r?e.replace(/^ +| +$/gm,"").replace(/ +/g," ").replace(/(\r\n)/g,"\n").replace(/\n\n\n+/g,"\n\n"):e.replace(/\s+/gi," "),o(t,i)},title:function(t){for(var r=t.split(" "),n=0;n<r.length;n++)r[n]=this.capitalize(r[n])
return o(t,r.join(" "))},trim:function(t){return o(t,t.replace(/^\s*|\s*$/g,""))},truncate:function(t,r,n,e){var i=t
if(r=r||255,t.length<=r)return t
if(n)t=t.substring(0,r)
else{var u=t.lastIndexOf(" ",r);-1===u&&(u=r),t=t.substring(0,u)}return t+=void 0!==e&&null!==e?e:"...",o(i,t)},upper:function(t){return t.toUpperCase()},wordcount:function(t){return t.match(/\w+/g).length},"float":function(t,r){var n=parseFloat(t)
